...
Definition better_t_tree_ind_type (X : Type) (P : t_tree X -> Prop) : Prop :=
  (P t_leaf) ->(forall l v r, P l -> P r -> P (t_branch (l, v, r))) ->
...
Definition better_t_tree_ind : forall (X : Type) (P : t_tree X -> Prop),
  better_t_tree_ind_type X P.
Proof.
  intros X P H_leaf H_branch.
  fix F 1.
  intros t.
  destruct t.
  - apply H_leaf.
