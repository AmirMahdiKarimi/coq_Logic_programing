...
| total_relation_intro : forall n m : nat, total_relation n m.
...
Proof.
  unfold partial_function.
  intros H.
  assert (total_relation 0 0) as H0_0.
  { apply total_relation_intro. }
  assert (total_relation 0 1) as H0_1.
  { apply total_relation_intro. }
  specialize (H 0 0 1 H0_0 H0_1).
  inversion H.
Qed.
