...
Proof.
  intros.
  assert (H1: n1 = f (f n1)) by apply H.
  assert (H2: n2 = f (f n2)) by apply H.
  rewrite H1.
  rewrite H2.
  rewrite H0.
  reflexivity.
...
Proof. intros. induction x. simpl. induction n.
  - simpl. reflexivity.
...
Proof. intros. simpl. rewrite eqb_id_refl. reflexivity. 
Qed.
